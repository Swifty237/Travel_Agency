...
export const servicesDatas = [
    {
        title: "Réservations",
        img: require("../assets/traveling-ticket-booking.jpg"),
    ...
    {
        title: "Comparateurs de prix",
        img: require("../assets/comparateur.jpg"),
    ...
    },
    {
        ...
        img: require("../assets/all-inclusive.jpg"),
    ...
    {
        title: "Croisières",
        img: require("../assets/cruise-ship.jpg"),
